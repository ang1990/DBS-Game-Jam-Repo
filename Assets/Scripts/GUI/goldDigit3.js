...
function Start () {
	...
	vertices = digit3.GetComponent(MeshFilter).mesh.vertices;
	uv = digit3.GetComponent(MeshFilter).mesh.uv;
...
function Update () {
	...
	{
		renderer.material.mainTexture = Resources.Load("GUI/Textures/numbers/" + num.ToString()[num.ToString().Length - 4], typeof(Texture2D)) as Texture;		
	}
	else {
