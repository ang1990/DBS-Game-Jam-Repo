...
function Start () {
	...
	vertices = digit1.GetComponent(MeshFilter).mesh.vertices;
	uv = digit1.GetComponent(MeshFilter).mesh.uv;
...
function Update () {
	...
	{
		renderer.material.mainTexture = Resources.Load("GUI/Textures/numbers/" + num.ToString()[num.ToString().Length - 2], typeof(Texture2D)) as Texture;		
	}
	else {
