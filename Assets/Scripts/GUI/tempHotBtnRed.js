...
private var tempHotBtnRed : GameObject;
...
function Start () {
	tempHotBtnRed = GameObject.Find("tempHotBtnRed");
	vertices = tempHotBtnRed.GetComponent(MeshFilter).mesh.vertices;
	uv = tempHotBtnRed.GetComponent(MeshFilter).mesh.uv;
