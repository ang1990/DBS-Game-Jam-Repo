...
function Start () {
	digit6 = GameObject.Find("digit6");
	vertices = digit6.GetComponent(MeshFilter).mesh.vertices;
	uv = digit6.GetComponent(MeshFilter).mesh.uv;
...
function Update () {
	...
	{
		renderer.material.mainTexture = Resources.Load("GUI/Textures/numbers/" + num.ToString()[num.ToString().Length - 7], typeof(Texture2D)) as Texture;		
	}
	else {
