...
function Start () {
	digit5 = GameObject.Find("digit5");
	vertices = digit5.GetComponent(MeshFilter).mesh.vertices;
	uv = digit5.GetComponent(MeshFilter).mesh.uv;
...
function Update () {
	...
	{
		renderer.material.mainTexture = Resources.Load("GUI/Textures/numbers/" + num.ToString()[num.ToString().Length - 6], typeof(Texture2D)) as Texture;		
	}
	else {
